...
public class DropAndCreate {
	...
	public static void main(String[] args) throws RemoteException, AlreadyBoundException {
		...
		Employee admin = new Employee("ADMIN", "ADMIN", new Date(), true, "@", "@", "@", new Date(), new BigDecimal(20000000),
				true, "ADMIN", true, d);

		Employee e = new Employee("TAI", "VÕ TRỌNG TÀI", new Date(), true, "@", "@", "@", new Date(), new BigDecimal(15000000),
				true, "QUẢN LÝ", true, d2);
		Employee e1 = new Employee("KHA", "HUỲNH THỊ NGỌC KHÁ", new Date(), true, "@", "@", "@", new Date(),
				new BigDecimal(17000000), true, "NHÂN VIÊN", true, d2 );
		Employee e2 = new Employee("E2", "HỌ VÀ TÊN", new Date(), true, "@", "@", "@", new Date(), new BigDecimal(10000000),
				true, "NHÂN VIÊN", false, d2);
		Employee e3 = new Employee("E3", "HỌ VÀ TÊN", new Date(), true, "@", "@", "@", new Date(), new BigDecimal(10000000),
				true, "NHÂN VIÊN", false, d2);
		Employee e4 = new Employee("E4", "HỌ VÀ TÊN", new Date(), true, "@", "@", "@", new Date(), new BigDecimal(10000000),
				true, "NHÂN VIÊN", false, d2);
		Employee e5 = new Employee("E5", "HỌ VÀ TÊN", new Date(), true, "@", "@", "@", new Date(), new BigDecimal(10000000),
				true, "NHÂN VIÊN", false, d2);
		Employee e6 = new Employee("E6", "HỌ VÀ TÊN", new Date(), true, "@", "@", "@", new Date(), new BigDecimal(10000000),
				true, "NHÂN VIÊN", false, d2);
		Employee e7 = new Employee("E7", "HỌ VÀ TÊN", new Date(), true, "@", "@", "@", new Date(), new BigDecimal(10000000),
				true, "NHÂN VIÊN", false, d2);
		Employee e8 = new Employee("E8", "HỌ VÀ TÊN", new Date(), true, "@", "@", "@", new Date(), new BigDecimal(10000000),
				true, "NHÂN VIÊN", false, d2);
		Employee e9 = new Employee("E9", "HỌ VÀ TÊN", new Date(), true, "@", "@", "@", new Date(), new BigDecimal(10000000),
				true, "NHÂN VIÊN", false, d2);
