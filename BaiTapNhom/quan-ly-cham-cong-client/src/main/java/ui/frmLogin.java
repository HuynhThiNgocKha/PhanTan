...
public class frmLogin extends JFrame {
	...
	private String uidString = "A001";
	private String pwdString = "password1";
	/**
	 * MÀN HÌNH ĐĂNG NHẬP
	 */
	public frmLogin() {
		...
		btnAttendence = new JButton("CHẤM CÔNG");
		btnAttendence.setFont(new Font("Tahoma", Font.BOLD, 20));

//		btnAttendence.addActionListener(new ActionListener() {
//			public void actionPerformed(ActionEvent e) {
//				System.out.println("Attendence");
//				try {
//					String x = uid.getText();
//					String y = uid.getText();
//					String z = new String(pwd.getPassword());
//					String maString = LoginDAO.validate(x, y, z);
//					if (maString != null) {
//						SimpleDateFormat dateFormat = new SimpleDateFormat("HH:mm:ss dd-MM-yyyy");
//
//						new EmployeeDAO();
//						Empolyee a = EmployeeDAO.getNVById(maString);
//						JOptionPane.showMessageDialog(null,
//								"INFO:\n" + dateFormat.format(new Date()) + "\n" + a.getlName() + " " + a.getfName(), "CHẤM CÔNG",
//								JOptionPane.INFORMATION_MESSAGE);
//
//					} else {
//						JOptionPane.showMessageDialog(null, "Sai thông tin đăng nhập", "?",
